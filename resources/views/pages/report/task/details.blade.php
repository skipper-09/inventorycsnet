                    ...
                    <div class="info-box info">
                        ...
                        <div class="d-flex align-items-center">
                            <span class="rounded-circle bg-info text-white fw-bold me-2"
                                style="width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">
                                {{ isset($employeeTask->employee->name) ? substr($employeeTask->employee->name, 0, 1) :
                                'N' }}
                            </span>
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="mb-3">
                                <div class="section-divider">
                                    <h6 class="fw-bold mb-2"><i class="fas fa-file-alt me-2"></i>Konten Laporan</h6>
                                </div>
                            ...
                            <div>
                                <div class="section-divider">
                                    <h6 class="fw-bold mb-2"><i class="far fa-images me-2"></i>Dokumentasi Visual</h6>
                                </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <a href="{{ asset('storage/report/' . $image->image) }}"
                                                ...
                                                <div class="gallery-image">
                                                    <span class="gallery-label bg-primary text-white">Sebelum</span>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <a href="{{ asset('storage/report/' . $image->image) }}"
                                                ...
                                                <div class="gallery-image">
                                                    <span class="gallery-label bg-success text-white">Sesudah</span>
                                                    <img src="{{ asset('storage/report/' . $image->image) }}"
                                                        alt="After Image">
                                                    <div class="gallery-overlay">
                                                        <i class="fas fa-search-plus me-1"></i>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="rounded-circle bg-info text-white fw-bold me-2"
                                                        ...
                                                        {{ isset($task->employee->name) ? substr($task->employee->name,
                                                        0, 1) : 'N' }}
                                                    </span>
                        ...
                        <button class="accordion-button {{ $index === 0 ? '' : 'collapsed' }}" type="button"
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span class="fw-bold">Laporan {{ $report->employeeTask->taskDetail->name}} #{{
                                            $index + 1 }}</span>
                                        <div class="d-flex align-items-center text-muted small">
                                            <i class="far fa-calendar-alt me-1"></i>
                                            <span>{{ formatDate($report->created_at) }}</span>
