...
chartColumnStackedColors &&
    ((options = {
        series: [
            ...
            { name: "PRODUCT D", data: [21, 10, 25, 13, 22, 8] },
        ],
        chart: {
            type: "bar",
            height: 350,
        ...
        plotOptions: { bar: { borderRadius: 10, horizontal: !0 } },
        xaxis: {
            type: "datetime",
            categories: [
                "01/01/2011 GMT",
...
function updateQuarterChart(t, e) {
    ...
    if (t.w.globals.selectedDataPoints[0]) {
        for (
            var a = t.w.globals.selectedDataPoints, s = 0;
            s < a[0].length;
            s++
        ) {
            var l = a[0][s],
                n = t.w.config.series[0];
            r.push({ name: n.data[l].x, data: n.data[l].quarters }),
...
var options = {
    ...
    title: { text: "Yearly Results", offsetX: 15, style: { fontWeight: 500 } },
...
chartQuarter.render(),
    chart.addEventListener("dataPointSelection", function (t, e, r) {
        var o = document.querySelector("#chart-quarter"),
            a = document.querySelector("#chart-year");
        1 === r.selectedDataPoints[0].length &&
            (o.classList.contains("active") ||
    ...
    (optionsGroup = {
        ...
        tooltip: {
            x: {
                formatter: function (t) {
                    return (
                        "Q" + dayjs(t).quarter() + " " + dayjs(t).format("YYYY")
                    );
                },
            },
        },
...
var chart,
    chartColumnDumbellColors = getChartColorsArray("column_dumbbell_chart");
chartColumnDumbellColors &&
    ((options = {
        series: [
            {
                data: [
    ...
    (chart = new ApexCharts(
        document.querySelector("#column_dumbbell_chart"),
        options
    )).render());
