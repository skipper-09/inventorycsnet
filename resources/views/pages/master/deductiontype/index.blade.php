...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            ...
                            data-route="{{ route('deductiontype.getdata') }}"
                            data-has-action-permission="{{ auth()->user()->canany(['update-deduction-type', 'delete-deduction-type'])? 'true': 'false' }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                    @canany(['update-deduction-type', 'delete-deduction-type'])
                                        <th>Action</th>
                                    @endcanany
                                </tr>
                            </thead>
    ...
    @include('pages.master.deductiontype.form')
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/deductiontype.js') }}"></script>
@endpush
