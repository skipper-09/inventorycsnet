...
@section('content')
                ...
                <div class="card">
                    @can('create-shift')
                        <div class="card-header">
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal8"
                                data-action="create" data-proses="{{ route('shift.store') }}"
                    ...
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            ...
                            data-route="{{ route('shift.getdata') }}"
                            data-has-action-permission="{{ auth()->user()->canany(['update-shift', 'delete-shift'])? 'true': 'false' }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                    ...
                                    <th>Jam Selesai</th>
                                    <th>Status</th>
                                    @canany(['update-shift', 'delete-shift'])
                                        <th>Action</th>
                                    @endcanany
                                </tr>
                            </thead>
    ...
    @include('pages.master.shift.form')
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/shift.js') }}"></script>
