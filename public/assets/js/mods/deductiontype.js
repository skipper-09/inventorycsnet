$(document).ready(function () {
        ...
        if (action === "create") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.deductionType) {
                        $("#addDeductionTypeForm #name").val(response.deductionType.name);
                    }
                },
    ...
    $("#addDeductionTypeForm").on("submit", function (e) {
        e.preventDefault();
