        ...
        <div class="card fade-in" style="animation-delay: 0.1s">
            <div class="card-header bg-white">
                <div class="d-flex align-items-center">
                    <span class="bg-primary rounded-circle me-3 text-white" style="width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">
                ...
                @if (count($taskReports) > 0)
                    <div class="accordion custom-accordion" id="reportAccordion">
                        @foreach ($taskReports as $index => $report)
                            <div class="accordion-item fade-in" style="animation-delay: {{ 0.3 + $index * 0.1 }}s">
                                    ...
                                    <button class="accordion-button {{ $index === 0 ? '' : 'collapsed' }}" type="button"
                                        ...
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="fw-bold">Laporan #{{ $index + 1 }}</span>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="section-divider">
                                                <h6 class="fw-bold mb-2"><i
                                                        class="fas fa-file-alt me-2"></i>Konten Laporan</h6>
                                            </div>
                                        ...
                                        @if ($report->reportImage && count($report->reportImage) > 0)
                                            <div>
                                                <div class="section-divider">
                                                    <h6 class="fw-bold mb-2"><i
                                                            class="far fa-images me-2"></i>Dokumentasi Visual</h6>
                                                </div>
                ...
                <div class="card-header bg-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="mb-0 fw-bold">Tugas Dengan Task ID yang Sama</h5>
                        </div>
                        <span class="badge-pill bg-primary text-white">
                            <i class="fas fa-list-ol me-1"></i> {{ $relatedTasks->flatten()->count() }} Tugas
                        </span>
                    </div>
                </div>
                <div class="card-body p-3">
                    <div class="accordion custom-accordion" id="relatedTasksAccordion">
                        @foreach ($relatedTasks as $date => $tasks)
                            <div class="accordion-item fade-in" style="animation-delay: {{ 0.3 + $loop->index * 0.1 }}s">
                                <h2 class="accordion-header" id="dateHeading{{ $loop->index }}">
                                    <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#dateCollapse{{ $loop->index }}"
                                        aria-expanded="{{ $loop->first ? 'true' : 'false' }}"
                                        aria-controls="dateCollapse{{ $loop->index }}">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="d-flex align-items-center">
                                                <span class="rounded-circle bg-success text-white me-2"
                                                    style="width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">
                                ...
                                <div id="dateCollapse{{ $loop->index }}"
                                    ...
                                    aria-labelledby="dateHeading{{ $loop->index }}"
                                    data-bs-parent="#relatedTasksAccordion">
