                ...
                <div class="card">
                    @can('create-salary')
                        <div class="card-header">
                            <a href="{{ route('salary.add') }}" class="btn btn-primary btn-sm">Tambah
                                {{ $title }}</a>
                        </div>
                    @endcan
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            ...
                            data-has-action-permission="{{ auth()->user()->canany(['read-salary', 'update-salary', 'delete-salary'])? 'true': 'false' }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Karyawan</th>
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/salary.js') }}"></script>
