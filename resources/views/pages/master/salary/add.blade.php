                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="basic_salary_amount" id="basic_salary_amount"
                                            ...
                                            value="{{ old('basic_salary_amount', '0') }}" oninput="calculateTotal()">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bonus" id="bonus"
                                            ...
                                            value="{{ old('bonus', '0') }}" oninput="calculateTotal()">
                                        @error('bonus')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="deduction" class="form-control currency-input" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Total Tunjangan</label>
                                        <input type="text" id="allowance" class="form-control currency-input" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="total_salary" class="form-control currency-input fw-bold"
                                            readonly>
                                    </div>
                                </div>
                            </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.currency-input').mask('000.000.000.000.000', {
                reverse: true,
                placeholder: "0"
            });
