    ...
    <div class="page-content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('office.update',['id'=>$office->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <select name="company_id"
                                        ...
                                        <option value="{{ $item->id }}" {{ $item->id == $office->company_id ? "selected" : " " }}>
                                            {{ $item->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{ $office->name }}"
                                        name="name" id="name" placeholder="Nama Kantor">
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" name="address"
                                        id="address" placeholder="Alamat Kantor">{{ $office->address }}</textarea>
                                    @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('lat') is-invalid @enderror" type="text" value="{{ $office->lat }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('long') is-invalid @enderror" type="text" value="{{ $office->long }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control  @error('radius') is-invalid @enderror" type="text" value="{{ $office->radius }}"
