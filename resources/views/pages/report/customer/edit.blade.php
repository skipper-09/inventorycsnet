                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <select name="branch_id" id="branch_id"
                                        ...
                                        <option value="{{ $item->id }}" {{ $item->id == $customer->branch_id ?
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="zone_id" id="zone_id"
                                        ...
                                        <option value="{{ $item->id }}" {{ $item->id == $customer->zone_id ? 'selected'
                                            : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('zone_id')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="custom-odp-container" class="mt-2" style="display:none;">
                                        <label for="custom_odp" class="form-label">Masukkan ODP (Bila Tidak Ada
                                            ODP)</label>
                                        <input type="text" id="custom_odp" name="odp_id" value="{{ $customer->odp_id }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" inputmode="numeric" name="phone" value="{{ $customer->phone }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="purpose"
                                        ...
                                        <option value="psb" {{ $customer->transaction->purpose =='psb' ? 'selected' : ''
                                            }}>Pemasangan
                                            Baru</option>
                                        <option value="repair" {{ $customer->transaction->purpose =='repair' ?
                                            'selected' : '' }}>
                                            Perbaikan</option>
                                    </select>
                                    @error('purpose')
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sn-modem-container" style="visibility: hidden;">
                                                        @php
                                                        $snModemArray =
                                                        json_decode($item->transaksi->customer->sn_modem);
                                                        $snModemArray = array_filter($snModemArray, function($value) {
                                                        return !empty($value);
                                                        });
                                                        $snModemValue = count($snModemArray) > 0 ? implode(', ',
                                                        $snModemArray) : '';
                                                        @endphp
...
$('form').on('submit', function(e) {
    ...
    $('#myTable tbody tr').each(function() {
        const selectElement = $(this).find('select[name="item_id[]"]');
        toggleSnModemInput(selectElement);  // Update visibilitas berdasarkan pilihan barang saat halaman dimuat
    });
