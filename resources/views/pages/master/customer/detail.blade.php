                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <h5 class="card-title mb-4">Informasi Customer</h5>
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            <tbody>
                                                <tr>
                                                    <th scope="row">Tanggal Pemasangan</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase">{{ $customer->zone->name }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Odp</th>
                                                    <td class="text-uppercase">{{ $customer->odp_id }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Cabang</th>
                                                    <td class="text-uppercase">{{ $customer->branch->name }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Teknisi Bertugas</th>
                                                    <td class="text-uppercase"> 
                                                        @foreach($customer->transaction->Transactiontechnition as $index => $teknisi)
