            ...
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal8"
                        data-action="create" data-proses="{{ route('incomeproduct.store') }}"
                ...
                <div class="card-body">
                    <table id="scroll-sidebar-datatable"
                        ...
                        data-route="{{ route('incomeproduct.getdata') }}">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Cabang</th>
...
@include('pages.transaction.incomeproduct.form')
...
<script src="{{ asset('assets/js/mods/incomeproduct.js') }}"></script>
