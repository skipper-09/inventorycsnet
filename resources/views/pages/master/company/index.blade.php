...
@section('content')
                ...
                <div class="card">
                    @can('create-company')
                        <div class="card-header">
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal8"
                                data-action="create" data-proses="{{ route('company.store') }}"
                    ...
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            ...
                            data-route="{{ route('company.getdata') }}"
                            data-has-action-permission="{{ auth()->user()->canany(['update-company', 'delete-company'])? 'true': 'false' }}">
                            <thead>
                                <tr>
                                    <th>No</th>
    ...
    @include('pages.master.company.form')
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/company.js') }}"></script>
@endpush
