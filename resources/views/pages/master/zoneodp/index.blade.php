            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button class="btn btn-primary btn-sm" id="SyncData" data-route="{{ route('zone.syncdata') }}" >Sync Data</button>
                    </div>
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            class="table dt-responsive nowrap w-100 table-hover table-striped"
                            data-route="{{ route('zone.getdata') }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Name</th>
...
<script src="{{ asset('assets/js/mods/zoneodp.js') }}"></script>
