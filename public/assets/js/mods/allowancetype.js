$(document).ready(function () {
        ...
        if (action === "create") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.allowanceType) {
                        $("#addAllowanceTypeForm #name").val(
                            response.allowanceType.name
                        );
                    }
                },
    ...
    $("#addAllowanceTypeForm").on("submit", function (e) {
        e.preventDefault();
