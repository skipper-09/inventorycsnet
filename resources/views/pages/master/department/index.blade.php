...
@section('content')
                ...
                <div class="card">
                    @can('create-department')
                        <div class="card-header">
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal8"
                                data-action="create" data-proses="{{ route('department.store') }}"
                    ...
                    <div class="card-body">
                        <table id="scroll-sidebar-datatable"
                            ...
                            data-route="{{ route('department.getdata') }}"
                            data-has-action-permission="{{ auth()->user()->canany(['update-department', 'delete-department'])? 'true': 'false' }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
    ...
    @include('pages.master.department.form')
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/department.js') }}"></script>
@endpush
