            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('activityreport.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label required">Laporan</label>
                                        <textarea class="form-control @error('report_activity') is-invalid @enderror" name="report_activity" id="report_activity" rows="10" placeholder="Laporan" required>{{ old('report_activity') }}</textarea>
...
@push('js')
    ...
    <script src="{{ asset('assets/js/mods/reportactivity.js') }}"></script>
