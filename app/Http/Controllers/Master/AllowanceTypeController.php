    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'status' => "Berhasil",
                'message' => 'Allowance Type Berhasil dibuat.',
            ]);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'status' => "Berhasil",
                'message' => 'Allowance Type Berhasil diupdate.',
            ]);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => 'success',
                'success' => true,
                'message' => 'Allowance Type Berhasil Dihapus!.',
            ]);
        } catch (Exception $e) {
            return response()->json([
                'message' => 'Gagal Menghapus Data Allowance Type!',
                'trace' => $e->getTrace()
            ]);
        }
    }
