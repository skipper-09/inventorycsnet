...
$(function () {
    ...
    $("#swal-1").on("click", function () {
        ...
        $("#swal-2").on("click", function () {
            n.fire("The Internet?", "That thing is still around?", "question");
        }),
        ...
        $("#swal-5").on("click", function () {
            n.fire({
                ...
                t.isConfirmed
                    ? n.fire("Saved!", "", "success")
                    : t.isDenied && n.fire("Changes are not saved", "", "info");
            });
        }),
        ...
        $("#swal-9").on("click", function () {
            ...
            n.fire({
                ...
                didOpen: function () {
                    n.showLoading();
                    var t = n.getHtmlContainer().querySelector("b");
                ...
                t.dismiss === n.DismissReason.timer &&
        ...
        $("#swal-10").on("click", function () {
            n.fire({
                ...
                preConfirm: function (t) {
                    return fetch("//api.github.com/users/".concat(t))
                        .then(function (t) {
